namespace InvalidRangeExceptionT
{
    using System;
    ...
    public class ExceptionMain
    {
        ...
        private static DateTime ReadDate(DateTime start, DateTime end)
        {
            ...
            {
                throw new InvalidRangeException<DateTime>("Input value was not in the range", start, end);
            }
        ...
        private static int ReadInteger(int start, int end)
        {
            ...
            {
                throw new InvalidRangeException<int>("Input value was not in the range", start, end);
            }
